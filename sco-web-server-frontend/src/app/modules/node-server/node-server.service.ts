...
export class NodeServerService {
    ...
    downloadFile(nodeServer: NodeServer): Observable<NodeServerDownload> {
        return this.http.post<NodeServerDownload>(`${environment.apiUrl}/node-server/downloadFile`, nodeServer);
    }
